            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="textbox">
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, protocol_type: e.target.value })
                  }
                >
              ...
              <div className="textbox">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, same_srv_rate: e.target.value })
                  }
                />
              </div>
              ...
              <div className="textbox">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, diff_srv_rate: e.target.value })
                  }
                />
              </div>
              ...
              <div className="textbox">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, dst_host_count: e.target.value })
                  }
                />
              </div>
